...
function initlegend(min, max) {
  str = "<table width='60%' border='1'><tr align='center'><td width='10%' bgcolor='#000000' style='color:white'>NIL</td><td width='10%' bgcolor='#ff0000'>";
  str = str + min + " - " + max/100 +"</td><td width='10%' bgcolor='#6666ff' style='color:white'>";
  str = str + max/100 + " - " + max/10 +"</td><td width='10%' bgcolor='#00ff00'>";
  str = str + max/10 + " - " + max/2 +"</td><td width='10%' bgcolor='#ffffff'>";
